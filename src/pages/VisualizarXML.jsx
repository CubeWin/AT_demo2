    ...
    <div className="bg-white pr-44 pl-44 min-h-screen">
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="col-span-3 flex relative">
          <label className="absolute top-0 left-0 text-[10px] text-gray-600">
            Archivo RH
          </label>
            ...
            <div className="col-span-3 mt-7 space-y-2">
              <div className="grid grid-cols-3 gap-9">
                <div className="col-start-1">
                  ...
                  <p><strong>Telefono:</strong> {invoiceData.customerPhone} </p>
                </div>
                ...
                <div className="col-start-1 col-span-3">
                  <p><strong>Recibi de:</strong> {invoiceData.companyName} </p>
                  <p><strong>Identificado con</strong> RUC <strong>numero</strong> {invoiceData.companyaRuc} </p>
                  <p><strong>Domiciliado en </strong> {invoiceData.streetCompanyName} </p>
                  <p><strong>Forma de Pago:</strong> {invoiceData.payName} </p>
                  <p><strong>La suma de:</strong> {invoiceData.payCompany} </p>
                  <p><strong>Por concepto:</strong> {invoiceData.descripcionPay} </p>
                  <p><strong>Observacion:</strong> { } </p>
                  <p><strong>Inciso</strong> "A" <strong>DEL ARTICULO 33 DE LA LEY DEL IMPUESTO DE LA RENTA</strong></p>
                  <p><strong>Fecha de emision:</strong> {invoiceData.emisionFecha} </p>
                </div>
                <div className="col-start-2 text-center">
                  <p><strong>Total del Honorario: {invoiceData.totalPay} </strong></p>
                  <p><strong>Retencion ({invoiceData.percent}%) IR: 0.00</strong></p>
                  <p><strong>Total Neto Recibido:</strong> {invoiceData.totalNetoPay} SOLES</p>
                </div>
              </div>
            </div>
          )}
